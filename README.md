...
```javascript
import unaryInputCastingDataType from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-unary-input-casting-dtype@v0.1.1-esm/index.mjs';
```
...
import inputCastingDataType from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-unary-input-casting-dtype@v0.1.1-esm/index.mjs';
